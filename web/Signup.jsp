        ...
        <section style="display: flex;
            ...
            <div 
                ...
                <form action="MainServlet" method="POST">
                    <input type="hidden" name="txtrole" value="1">
                    ...
                    <div style="width: 100%;
                         ...
                         margin: 30px 0;
                         ">
                        <input class="input_text" type="email" name="txtemail" value="${requestScope.txtemail}" placeholder="Email" required=/><br>
                    ...
                    <div style="width: 100%;
                         ...
                         margin: 30px 0;
                         ">
                        <input class="input_text" type="password" name="txtpass" value="${requestScope.txtpast}" placeholder="Password"  required=/><br>
                    ...
                    <div style="width: 100%;
                         ...
                         margin: 30px 0;
                         ">
                        <input class="input_text" type="text" name="txtname"  value="${requestScope.txtfullname}" pattern="[a-z][A-Z]{1,15 placeholder="Full name"  required=/><br>
                    ...
                    <div style="width: 100%;
                         ...
                         margin: 30px 0;
                         ">
                        <input class="input_text" type="text" name="txtaddress" value="${requestScope.txtaddress}" placeholder="Address" required=/><br>
                    ...
                    <div style="width: 100%;
                         ...
                         margin: 30px 0;
                         ">
                        <input class="input_text" type="text" name="txtphone" pattern="[0-9]{10}" value="${requestScope.txtphone}" placeholder="Phone number" required=/><br>
                        <i class='bx bxs-phone' ></i>
                    </div>

                    ${requestScope.ERROR}<br>
                    <input type="submit" value="Register" name="action" class="btn"/>
                </form>
            </div>
        </section>
